...
with st.sidebar:
    ...
    # Link direto para a logo.png no repositório para evitar erro de carregamento
    logo_path = "https://raw.githubusercontent.com/yaramaia122-lgtm/logistica-aura/main/logo.png"
    
    st.markdown(f'''
        <div class="logo-container">
            <img src="{logo_path}" width="220" onerror="this.src='https://raw.githubusercontent.com/yaramaia122-lgtm/logistica-aura/main/Aura%20(Azul%20e%20Ocre)%20(1).png'">
        </div>
    ''', unsafe_allow_html=True)
...
if menu == "📋 Agenda de Viagens":
    ...
    with st.form("form_v", clear_on_submit=True):
        ...
        obs_itinerario = st.text_input("Descrição de Outros / Observações")
